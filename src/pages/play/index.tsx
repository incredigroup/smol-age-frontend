...
const Play: NextPage = () => {
  ...
  return (
    <div className="relative min-h-screen bg-[url('/static/images/phase2/landing.gif')] bg-cover bg-center">
      <ClientOnly>
        <GroundsState percentage={percentage.toFixed(3)} open={open} />
      </ClientOnly>
      <div className="space-y-6 pt-10 max-md:relative sm:pt-[260px]">
        {breakPoint < WindowSize.MD ? (
          <>
            <Link
              href="/phase2/caves"
              id="btn-caves"
              className="mx-auto flex max-w-[350px] items-center justify-center border-[6px] border-smol-brown-light bg-smol-brown px-8 py-3 md:absolute md:left-[5%] md:top-[25%]"
            >
            ...
            <Link
              ...
              id="btn-dev-grounds"
              className="mx-auto flex max-w-[350px] items-center justify-center border-[6px] border-smol-brown-light bg-smol-brown px-8 py-3 md:absolute md:bottom-[32%] md:left-[10%]"
            >
            ...
            <Link
              ...
              className="mx-auto flex max-w-[350px] items-center justify-center border-[6px] border-smol-brown-light bg-smol-brown px-8 py-3 md:absolute md:bottom-[30%] md:right-[10%]"
            >
              <p className="text-xs font-bold uppercase tracking-widest text-white">
                Labor Grounds
              </p>
            ...
            <Link
              href="/phase2/pits"
              id="btn-pits"
              className="mx-auto flex max-w-[350px] items-center justify-center border-[6px] border-smol-brown-light bg-smol-brown px-8 py-3 md:absolute md:bottom-[10%] md:left-[40%]"
            >
            ...
            <Link
              ...
              id="btn-custom"
              className="mx-auto flex max-w-[350px] items-center justify-center border-[6px] border-smol-brown-light bg-smol-brown px-8 py-3 md:absolute md:right-[10%] md:top-[40%]"
            >
            ...
            <Link
              href="/phase1"
              id="btn-phase1"
              className="mx-auto flex max-w-[350px] items-center justify-center gap-2 border-[6px] border-smol-brown-light bg-smol-brown px-8 py-3 md:absolute md:right-[10%] md:top-[40%]"
            >
              <p className="text-xs font-bold uppercase tracking-widest text-white">Phase 1</p>
            </Link>
          </>
        ) : (
          <>
            ...
            <Link
              href="/phase1"
              id="btn-phase1"
              className="mx-auto flex max-w-[350px] items-center justify-center gap-2 border-[6px] border-smol-brown-light bg-smol-brown px-8 py-2 md:absolute md:bottom-[3%] md:right-[3%]"
            >
              <p className="text-xs font-bold uppercase tracking-widest text-white">Phase 1</p>
        ...
        <Tooltip anchorSelect="#btn-caves" place="top" className="max-w-[350px] leading-6">
          Hibernate in the Caves for 100 days, Neandersmols collect 10 bones per day
        </Tooltip>
        <Tooltip anchorSelect="#btn-dev-grounds" place="top" className="max-w-[350px] leading-6">
          Enter the development grounds to learn a skill.
          <br /> With great skill comes great responsibility!
        </Tooltip>
        <Tooltip anchorSelect="#btn-pits" place="top" className="max-w-[350px] leading-6">
          Provide your bones to the Pits.
          <br /> 30% of bones must be staked to keep the grounds open.
        </Tooltip>
        <Tooltip anchorSelect="#btn-labor-grounds" place="top" className="max-w-[350px] leading-6">
          Enter the labour grounds to look for rare items.
          <br /> Take an animal for better outcomes!
        </Tooltip>
        <Tooltip anchorSelect="#btn-custom" place="top" className="max-w-[350px] leading-6">
