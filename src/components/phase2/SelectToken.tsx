  ...
  return (
    <Listbox value={selected} onChange={handleChange}>
      <div className="relative w-60">
        ...
        <Listbox.Button className="relative mt-2 w-full rounded-lg bg-gray-300 py-2 pl-3 pr-10 text-left text-sm">
        ...
        <Transition
          ...
          leaveTo="opacity-0"
        >
          <Listbox.Options className="absolute mt-1 max-h-60 w-full overflow-auto rounded-lg bg-gray-200 py-1 text-xs">
