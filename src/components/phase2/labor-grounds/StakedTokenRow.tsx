...
import { animals, hasAnimal } from './MyStakes';
              ...
              {hasAnimal(token) && animal ? (
                ...
                <>
                  <div className="relative">
                    ...
                    />
                    <div
                      className="absolute -right-0.5 -top-0.5 mx-auto h-[25px] w-[25px] rounded-full border border-smol-brown-light bg-[#8a0303] leading-5"
                      onClick={(e) => {
                        e.stopPropagation();
