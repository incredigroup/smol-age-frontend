...
export const animals: Animal[] = [
  ...
  { name: 'WOLF', image: '/static/images/phase2/animals/wolf.gif', id: BigNumber.from(1) },
  {
    name: 'SABERTOOTH',
    image: '/static/images/phase2/animals/sabertooth.gif',
    id: BigNumber.from(2),
  },
  { name: 'TREX', image: '/static/images/phase2/animals/trex.gif', id: BigNumber.from(3) },
  { name: 'MAMMOTH', image: '/static/images/phase2/animals/mammoth.gif', id: BigNumber.from(4) },
  { name: 'WHALE', image: '/static/images/phase2/animals/whale.gif', id: BigNumber.from(5) },
];
...
export const MyStakes = ({ job }) => {
  ...
  return (
    <>
      ...
      <div
        className="mx-auto mt-4 flex flex-col justify-between  gap-5 sm:flex-row"
