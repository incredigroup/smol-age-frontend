      ...
      <Dialog as="div" className="relative z-10" onClose={closeWindow}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="relative w-full max-w-[600px] overflow-hidden rounded-lg border-8 border-smol-brown bg-smol-brown-alternative px-7 pb-10 pt-7 text-gray-200">
                <div className="mx-auto flex h-full w-fit flex-col justify-center p-2">
                  ...
                  <div className="xxs:grid-cols-2 xxs:gap-6 grid grid-cols-1 gap-3 pt-[20px] xs:grid-cols-3">
                    <div className="xxs:w-[150px] flex h-[40px] w-full justify-between rounded-lg border-4 border-smol-brown bg-[#ffe3bd] px-[8px] py-[10px] shadow-[inset_0_1px_4px_rgba(0,0,0,0.8)]">
                      <Image
                      ...
                      />
                      <p className="text-xs text-smol-brown">
                    ...
                    <div className="xxs:w-[150px] flex h-[40px] w-full justify-between rounded-lg border-4 border-smol-brown bg-[#ffe3bd] px-[8px] py-[10px] shadow-[inset_0_1px_4px_rgba(0,0,0,0.8)]">
                      <Image
                        ...
                        className="-my-[8px] -ml-[20px] rounded-full"
                      />
                      <p className="text-xs text-smol-brown">{moonrocksBalance?.toNumber() ?? 0}</p>
                    </div>
                  </div>
                            ...
                            animals.map((token, index) => (
                              ...
                              >
                                <Image
                                  ...
                                  width={50}
                                  alt={token.name}
                                  className="aspect-square border-4 border-smol-brown-light"
                                />
                  ...
                  <button
                    className="absolute -top-[6px] right-[0px] flex rounded-full p-2 text-lg text-white"
                    onClick={closeWindow}
                  >
                    x
                  </button>
