...
export type LaborGroundFeInfoStructOutput = [BigNumber, BigNumber, BigNumber, BigNumber] & {
  timeLeft: BigNumber;
  tokenId: BigNumber;
  animalId: BigNumber;
  supplyId: BigNumber;
...
export interface LaborGroundsInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'consumables', values?: undefined): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: 'getStakedTokens', values: [PromiseOrValue<string>]): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: 'neandersmol', values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: 'consumables', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'enterLaborGround', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'getLaborGroundFeInfo', data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: 'neandersmol', data: BytesLike): Result;
...
export interface LaborGrounds extends BaseContract {
  ...
  getStakedTokens(_owner: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber[]>;
