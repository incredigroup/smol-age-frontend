...
export interface AnimalsInterface extends utils.Interface {
  functions: {
    ...
    'mintForWallet(uint256,address[],uint256[])': FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: 'mintForWallet',
    values: [
  ...
  decodeFunctionResult(functionFragment: 'mintForWallet', data: BytesLike): Result;
...
export interface Animals extends BaseContract {
