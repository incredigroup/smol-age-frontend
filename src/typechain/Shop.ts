...
export interface ShopInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'laborGround', values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: 'laborGround', data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: 'setLaborGroundAddresss', data: BytesLike): Result;
