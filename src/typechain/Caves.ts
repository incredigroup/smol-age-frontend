...
export interface CavesInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'getCavesFeInfo', values: [PromiseOrValue<string>]): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: 'getCavesFeInfo', data: BytesLike): Result;
...
export type LeaveCaveEvent = TypedEvent<[string, BigNumber], LeaveCaveEventObject>;
...
export interface Caves extends BaseContract {
  ...
  estimateGas: {
    ...
    getCavesFeInfo(_user: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
