...
export interface DevelopmentGroundsInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'calculateBones', values: [PromiseOrValue<string>]): string;
  ...
  decodeFunctionResult(functionFragment: 'bonesToTime', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'calculateBones', data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: 'getDevGroundFeInfo', data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: 'getDevelopmentGroundBonesReward',
    data: BytesLike,
  ): Result;
  ...
  decodeFunctionResult(functionFragment: 'removeSingleBones', data: BytesLike): Result;
...
export interface DevelopmentGrounds extends BaseContract {
  ...
  estimateGas: {
    ...
    calculateBones(_owner: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
